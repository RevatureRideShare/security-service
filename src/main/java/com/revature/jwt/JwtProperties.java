...
/**
 * JwtProperties is the class that acts as the basis to build the JWT that is sent back on user
 * login.
 * 
 * @author Michael
 *
...
public class JwtProperties {
  ...
  /**
   * This field is a string that helps verify that JWTs provided by the client came from the
  ...
  /**
   * This field is a prefix attached to the value of the JWT key value pair. It is provided in plain
   * text.
   */
