...
public class SecurityController {
	...
	//! Method for directing post requests for persisting new security objects in the security table. Primarily for testing purposes.
	//! Takes a JSON object from the request body and transforms it into a security object.
	//! Returns a response with the 200 status code if the operation was successful, or a 400 status code if the operation failed (almost certainly due to a duplicate email).
	...
	//! Method for authorizing partial updates to any user object in the user table in the user microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	@PatchMapping("/user/*")
	...
	//! Method for authorizing getting all users who have a specific role from the user table in the user microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing getting a single user from the user table by their email in the user microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing getting the cars owned by a specific user based on the user's email in the user microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing creation of a new housing location from the housing-location table in the location microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing getting a list of all housing locations from the housing-location table in the location microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing getting a list of all housing locations by the training location from the housing location table in the location microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing creation of new training locations in the training-location table in the location microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
	...
	//! Method for authorizing getting a list of all training locations from the training-location table in the location microservice.
	//! Requires a JWT passed in the HttpRequest header.
	//! Returns a 200 status code with "Success" in the response body if the user is allowed to perform the operation, 
	//! returns a 403 status code if the user isn't allowed to perform the operation.
